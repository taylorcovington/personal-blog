      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Sr. Software Developer, Indie Maker, and Nutrition Coach.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Taylor, a software developer and entrepreneur based in Salt Lake
            City. I’m currenly building MacroFlex, making it easier for
            nutrition coaches to get their clients results using a data driven
